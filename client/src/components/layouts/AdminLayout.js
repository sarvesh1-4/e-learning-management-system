...
import { LayoutDashboard, BookOpen, FileQuestion, BarChart3, LogOut, Menu, X, User } from "lucide-react"
        ...
        >
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            ...
            <nav className="mt-5 px-2 space-y-1">
              ...
              <Link to="/assignments/review" className="sidebar-link" activeClassName="active">
          ...
          <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
            <div className="flex items-center">
              <div className="bg-blue-100 p-2 rounded-full overflow-hidden w-10 h-10 flex items-center justify-center">
                {user?.avatar ? (
                  <Link to="/profile">
